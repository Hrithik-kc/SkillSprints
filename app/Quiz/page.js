...
export default function Quiz() {
  ...
  const startQuiz = async () => {
    ...
    try {
      ...
      setTime(quizType === "practice" ? 600 : 1200);
    } catch (error) {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-amber-50 rounded-2xl shadow-xl p-8 space-y-8">
            ...
            <button
              onClick={startQuiz}
              disabled={loading}
              className="w-full bg-linear-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-xl font-bold text-lg hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <div className="flex items-center justify-between">
            ...
            {currentQuestion === questions.length - 1 ? (
              <button
                ...
                className="px-6 py-3 bg-linear-to-r from-green-500 to-green-600 text-white rounded-lg font-semibold hover:from-green-600 hover:to-green-700 transition-all shadow-lg"
              >
                Submit Quiz →
              </button>
            ) : (
